...
public:
	 ...
	 *                               bad tower_id, max level, or insufficient money
	 */
	 ...
	 * @param[in]  is_base  bool is_base makes the tower invincible when set to true
	 *                      set to false by default
	 *
	 * @throw      std::out_of_range If the tower cannot be built due to bad terrain,
	 *                               ownership, position, or insufficient balance
	 */
